...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxitabsstylecss')) {
        ...
        $data = 'heading-font-size |' . sanitize_text_field($_POST['heading-font-size']) . '|'
                ...
                . ' heading-box-shadow-color |rgba(225, 225, 225, 0.57)|'
                . ' content-font-size |' . sanitize_text_field($_POST['content-font-size']) . '|'
                . ' content-font-color |#585a61|'
                ...
                . ' content-box-shadow-color |rgba(225, 225, 225, 0.57)|'
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-4">
                                        <div class="oxilab-tabs-content-div-50">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <div class="form-group row form-group-sm">
                                                    <label for="heading-background-color" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Set Your Title background Color, Based on Color">Background <span class="oxilab-pro-only">Pro</span></label>
                                                    <div class="col-sm-6">
                                                ...
                                                <div class="form-group row form-group-sm">
                                                    <label for="heading-font-active-color" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Customize Yout Active Title Font Color, Based on Color">Color Active <span class="oxilab-pro-only">Pro</span></label>
                                                    <div class="col-sm-6">
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-3">
                                        ...
                                        <div class="oxilab-tabs-content-div-50">
                                            ...
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <div class="form-group row form-group-sm">
                                                    <label for="content-box-shadow-color" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Add custom Shadow Collor to Content Box">Box Shadow Color <span class="oxilab-pro-only">Pro</span> </label>
                                                    <div class="col-sm-6">
                                                        <input data-format="rgb" data-opacity="true"  type="text" class="form-control oxilab-vendor-color" id="content-box-shadow-color" name="content-box-shadow-color" value="<?php echo $styledata[51]; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <script type="text/javascript">
                            jQuery(document).ready(function () {
                                ...
                                jQuery("#heading-background-active-color").on("change", function () {
                                    ...
                                    jQuery("<style type='text/css'> .ctu-ulimate-style-<?php echo $styleid; ?> li{border-right: " + jQuery("#heading-background-active-color").val() + "1px solid; } </style>").appendTo("#oxilab-preview-data");
