...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxitabsstylecss')) {
        ...
        $data = 'heading-font-size |' . sanitize_text_field($_POST['heading-font-size']) . '|'
                ...
                . 'heading-background-color |rgba(0, 186, 164, 1)| '
                . 'heading-border-color |#04cee0| '
                . 'heading-font-active-color |#ffffff|'
                . ' heading-background-active-color |rgba(0, 189, 54, 1)| '
                . 'heading-border-active-color |#cf04ad| '
                ...
                . ' heading-box-shadow-color |rgba(217, 217, 217, 1)| '
                . 'content-font-size |' . sanitize_text_field($_POST['content-font-size']) . '| '
                . 'content-font-color |#919191| '
                ...
                . 'content-box-shadow-color |#d4d4d4| '
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-4">
                                        <div class="oxilab-tabs-content-div-50">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <div class="form-group row form-group-sm">
                                                    <label for="heading-border-color" class="col-sm-6 control-label"  data-toggle="tooltip" data-placement="top" title="Customize your Heading Border Color">Border <span class="oxilab-pro-only">Pro</span></label>
                                                    <div class="col-sm-6 ">
                                                        <input type="text" class="form-control oxilab-vendor-color" id="heading-border-color" name="heading-border-color" value="<?php echo$styledata[7]; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row form-group-sm">
                                                    ...
                                                    <div class="col-sm-6 ">
                                                        <input type="text" class="form-control oxilab-vendor-color" id="heading-font-active-color" name="heading-font-active-color" value="<?php echo $styledata[9]; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row form-group-sm">
                                                    ...
                                                    <div class="col-sm-6 ">
                                                        <input type="text" data-format="rgb" data-opacity="true" class="form-control oxilab-vendor-color" id="heading-background-active-color" name="heading-background-active-color" value="<?php echo $styledata[11]; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row form-group-sm">
                                                    <label for="heading-font-border-color" class="col-sm-6 control-label"  data-toggle="tooltip" data-placement="top" title="Customize your Active Border Color">Active Border <span class="oxilab-pro-only">Pro</span></label>
                                                    <div class="col-sm-6 ">
                                                        <input type="text" class="form-control oxilab-vendor-color" id="heading-border-active-color" name="heading-border-active-color" value="<?php echo $styledata[13]; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row form-group-sm">
                                        ...
                                        <div class="oxilab-tabs-content-div-50">
                                            ...
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <div class="form-group row form-group-sm">
                                                    <label for="heading-box-shadow-color" class="col-sm-6 control-label"  data-toggle="tooltip" data-placement="top" title="Add Shadow Color to Title Box, Based on Color">Box Shadow Color <span class="oxilab-pro-only">Pro</span> </label>
                                                    <div class="col-sm-6 ">
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-3">
                                        ...
                                        <div class="oxilab-tabs-content-div-50">
                                            ...
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <div class="form-group row form-group-sm">
                                                    <label for="content-box-shadow-color" class="col-sm-6 control-label"  data-toggle="tooltip" data-placement="top" title="Add custom Shadow Color to Content Box">Box Shadow Color <span class="oxilab-pro-only">Pro</span> </label>
                                                    <div class="col-sm-6">
                                                        <input type="text" class="form-control oxilab-vendor-color" id="content-box-shadow-color" name="content-box-shadow-color" value="<?php echo $styledata[51]; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row form-group-sm">
                          ...
                          <script type="text/javascript">
                            jQuery(document).ready(function () {
                                ...
                                jQuery("#heading-border-color").on("change", function () {
                                    jQuery("<style type='text/css'> .ctu-ulimate-style-<?php echo $styleid; ?> li{border-color: " + jQuery("#heading-border-color").val() + "; } </style>").appendTo("#oxilab-preview-data");
                                });
                                ...
                                jQuery("#heading-background-active-color").on("change", function () {
                                    jQuery("<style type='text/css'> .ctu-ulimate-style-<?php echo $styleid; ?> li.active{background-color: " + jQuery("#heading-background-active-color").val() + "; } </style>").appendTo("#oxilab-preview-data");
                                ...
                                jQuery("#heading-border-active-color").on("change", function () {
                                    jQuery("<style type='text/css'> .ctu-ulimate-style-<?php echo $styleid; ?> li.active{border-color: " + jQuery("#heading-border-active-color").val() + "; } </style>").appendTo("#oxilab-preview-data");
                                });
                              ...
                              jQuery("#heading-text-align").on("change", function () {
                                ...
                                jQuery("#heading-padding").on("change", function () {
                                    jQuery("<style type='text/css'> .ctu-ulimate-style-<?php echo $styleid; ?> li{padding: " + jQuery("#heading-padding").val() + "px 10px; } </style>").appendTo("#oxilab-preview-data");
                                ...
                                jQuery("#heading-margin-right").on("change", function () {
                                    jQuery("<style type='text/css'> .ctu-ulimate-style-<?php echo $styleid; ?> li{margin: 0 " + jQuery("#heading-margin-right").val() + "px 0 0; } </style>").appendTo("#oxilab-preview-data");
                                });
