...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxitabsstylecss')) {
        ...
        $data = 'heading-font-size |' . sanitize_text_field($_POST['heading-font-size']) . '|'
                ...
                . ' heading-background-color |rgba(160, 42, 196, 1)|'
                . ' heading-font-active-color |#ffffff|'
                . ' heading-background-active-color |rgba(43, 48, 194, 0.81)| '
                ...
                . 'content-box-shadow-color |rgba(230, 230, 230, 0.6)|  '
                       ...
                       <script type="text/javascript">
                            jQuery(document).ready(function () {
                                ...
                                jQuery("#heading-font-active-color").on("change", function () {
                                    ...
                                    jQuery("<style type='text/css'> .ctu-ulimate-style-<?php echo $styleid; ?> li.active .ctu-absolute{ background-color: " + jQuery('#heading-font-active-color').val() + ";} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo $styleid; ?>");
                                });
                                ...
                                jQuery("#heading-padding-top-bottom").on("change", function () {
                                    jQuery("<style type='text/css'> .ctu-ulimate-style-<?php echo $styleid; ?> li{ padding-top: " + jQuery('#heading-padding-top-bottom').val() + "px;} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo $styleid; ?>");
                                    jQuery("<style type='text/css'> .ctu-ulimate-style-<?php echo $styleid; ?> li{ padding-bottom: " + jQuery('#heading-padding-top-bottom').val() + "px;} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo $styleid; ?>");
                                });
                                jQuery("#heading-padding-left-right").on("change", function () {
                                    jQuery("<style type='text/css'> .ctu-ulimate-style-<?php echo $styleid; ?> li{ padding-left: " + jQuery('#heading-padding-left-right').val() + "px;} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo $styleid; ?>");
                                    jQuery("<style type='text/css'> .ctu-ulimate-style-<?php echo $styleid; ?> li{ padding-right: " + jQuery('#heading-padding-left-right').val() + "px;} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo $styleid; ?>");
                                });
