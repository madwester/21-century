...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxitabsstylecss')) {
        ...
        $data = 'heading-font-size |' . sanitize_text_field($_POST['heading-font-size']) . '|'
                . ' heading-font-color |#adadad|'
                . ' heading-background-color |rgba(255, 255, 255, 1)|'
                . ' heading-font-active-color |#00b9f7|'
                . ' heading-font-border-color |#ededed|'
                ...
                . ' heading-box-shadow-color |rgba(196, 196, 196, 1)|'
                ...
                . ' content-box-shadow-color |rgba(219, 219, 219, 1)|'
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-4">
                                        <div class="oxilab-tabs-content-div-50">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <div class="form-group row form-group-sm">
                                                    <label for="heading-font-border-color" class="col-sm-6 control-label"  data-toggle="tooltip" data-placement="top" title="Customize your Title Border Color">Border Color <span class="oxilab-pro-only">Pro</span></label>
                                                    <div class="col-sm-6 ">
                                                        <input type="text" class="form-control oxilab-vendor-color" id="heading-font-border-color" name="heading-font-border-color" value="<?php echo $styledata[9]; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row form-group-sm">
                        ...
                        <script type="text/javascript">
                            jQuery(document).ready(function () {
                                ...
                                jQuery("#heading-background-color").on("change", function () {
                                    ...
                                    jQuery("<style type='text/css'> .ctu-ulimate-style-<?php echo $styleid; ?> li.active .ctu-absolute{ border-top-color: " + jQuery('#heading-background-color').val() + ";} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo $styleid; ?>");
                                });
                                ...
                                jQuery("#heading-font-border-color").on("change", function () {
                                    jQuery("<style type='text/css'> .ctu-ulimate-style-<?php echo $styleid; ?> li{ border-color: " + jQuery('#heading-font-border-color').val() + ";} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo $styleid; ?>");
                                });
                                ...
                                jQuery("#heading-padding").on("change", function () {
                                    jQuery("<style type='text/css'> .ctu-ulimate-style-<?php echo $styleid; ?> li{ margin: " + jQuery('#heading-padding').val() + "px 0;} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo $styleid; ?>");
                                    jQuery("<style type='text/css'> .ctu-ulimate-style-<?php echo $styleid; ?> li.active .ctu-absolute{ bottom: calc(-10px - " + jQuery('#heading-padding').val() + "px);} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo $styleid; ?>");
                                });
