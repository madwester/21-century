...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxitabsstylecss')) {
        ...
        $data = 'heading-font-size |' . sanitize_text_field($_POST['heading-font-size']) . '|'
                ...
                . ' heading-background-color |rgba(241, 245, 248, 1)|'
                . ' heading-border-color |#dedede|'
                . ' heading-font-active-color |#00bda1|'
                ...
                . ' content-font-color |#808080| '
                . ' content-background-color |rgba(255, 255, 255, 1)|'
                . ' content-border-left-color |#b3b3b3|'
                ...
                . 'content-box-shadow-color |#c2c2c2| '
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-3">
                                        <div class="oxilab-tabs-content-div-50">
                                            ...
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <div class="form-group row form-group-sm">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="text" data-format="rgb" data-opacity="true" class="form-control oxilab-vendor-color" id="content-box-shadow-color" name="content-box-shadow-color" value="<?php echo $styledata[53]; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="oxilab-tabs-content-div-50">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <div class="form-group row form-group-sm">
                                                    <label for="content-border-left-color" class="col-sm-6 control-label"  data-toggle="tooltip" data-placement="top" title="Select Border left Color">Border left Color <span class="oxilab-pro-only">Pro</span> </label>
                                                    <div class="col-sm-6">
                                                        <input type="text" class="form-control oxilab-vendor-color" id="content-border-left-color" name="content-border-left-color" value="<?php echo $styledata[31]; ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group row form-group-sm">
                       ...
                       <script type="text/javascript">
                            jQuery(document).ready(function () {
                                ...
                                jQuery("#heading-width").on("change", function () {   
                                    ...
                                    jQuery("<style type='text/css'> .ctu-ulimate-style-<?php echo $styleid; ?> li{max-width: " + jQuery("#heading-width").val() + "px; } </style>").appendTo("#oxilab-preview-data");
                                ...
                                jQuery("#heading-padding-up-bottom").on("change", function () {
                                    jQuery("<style type='text/css'> .ctu-ulimate-style-<?php echo $styleid; ?> li{padding: " + jQuery("#heading-padding-up-bottom").val() + "px " + jQuery("#heading-padding-left-right").val() + "px;} </style>").appendTo("#oxilab-preview-data");
