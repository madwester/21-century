...
function oxi_responsive_tabs_shortcode_function_style15($styleid, $userdata, $styledata, $listdata) {
    wp_enqueue_style('cau-google-font', 'https://fonts.googleapis.com/css?family=' . $styledata[11] . '|' . $styledata[39] . '');
    ?>
    ...
    <style>
        ...
        .ctu-ulimate-style-<?php echo $styleid; ?> li .fa{
        ...
        .ctu-ultimate-style-heading-<?php echo $styleid; ?> .fa{
            font-size: <?php echo $styledata[17]; ?>px;
            margin-right: 10px;
        }
