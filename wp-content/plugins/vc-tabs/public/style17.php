...
function oxi_responsive_tabs_shortcode_function_style17($styleid, $userdata, $styledata, $listdata) {
    wp_enqueue_style('cau-google-font', 'https://fonts.googleapis.com/css?family=' . $styledata[11] . '|' . $styledata[51] . '');
    ?>
    <style>
        ...
        .ctu-ulitate-style-<?php echo $styleid; ?>-tabs{
            ...
            padding: <?php echo $styledata[41]; ?>px <?php echo $styledata[43]; ?>px <?php echo $styledata[69]; ?>px <?php echo $styledata[47]; ?>px ;
