...
function oxi_responsive_tabs_shortcode_function_style20($styleid, $userdata, $styledata, $listdata) {
    wp_enqueue_style('cau-google-font', 'https://fonts.googleapis.com/css?family=' . $styledata[3] . '|' . $styledata[29] . '');
    ?>
    ...
    <div class="ctu-ultimate-wrapper-<?php echo $styleid; ?>">
        <ul class="ctu-ulimate-style-<?php echo $styleid; ?>">
            ...
            foreach ($listdata as $value) {
                ...
                echo '<li ref="#ctu-ulitate-style-' . $styleid . '-id-' . $value['id'] . '" class="" style="color: ' . $cssdata[1] . '; background-color:  ' . $cssdata[3] . '">
