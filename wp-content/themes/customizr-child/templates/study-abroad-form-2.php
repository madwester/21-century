  ...
  ?>
    ...
    <div id="main-wrapper" class="section">
          ...
          <div class="<?php czr_fn_main_container_class() ?>" role="main">
            ...
            <div class="choice-box">
                    ...
                    <div class="row-radio">
                        ...
                        <div class="radio-title">
                            ...
                            <form action="schoolList.php" method="get" name="MyForm" id="MyForm"  />
                            
                            <p class="radio-p">澳洲一年级（小学）</p>
                            
                            <h6 class="radio-features">特点：针对小学一年级上半学期在读学生</h6>
                        </div>
                    </div>
            ...
            <a href="https://ct21-wordpress-lyf9375.c9users.io/study-abroad-program-step-1/"><button type="button" class="btn btn-slide">上一步</button></a>
            <a href="https://ct21-wordpress-lyf9375.c9users.io/study-abroad-program-step-3/"><button type="button" class="btn btn-slide">下一步</button></a>
        </div>
                    </div>
