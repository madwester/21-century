...
<div class="container" style="margin-bottom: 30px;">
  <div class="row">
    <div class="col-3 text-center">
      <img src="https://dummyimage.com/150%20x%20100/000000/ffffff.jpg&text=Logotype+School">
    </div>
    <div class="col-9">
      <h5 class="less-margin">Placeholder: Name of school</h5>
      <h5 class="less-margin">Placeholder: Country</h5>
      <h5 class="less-margin">Placeholder: New South Wales</h5>
    </div>
  </div>
</div>
<div class="container">
...
<li class="nav-item">
  <a class="nav-link" data-toggle="tab" href="#profession" role="tab">Profession</a>
</li>
</ul>
  ...
  <div class="container">
    <div class="row">
      <div class="col-12">
        ...
        <h4 class="less-margin">School Overview</h4>
        <p class="less-margin">Placeholder: School Information</p>
      </div>
    </div>
  </div>
</div>
...
<div class="tab-pane" id="profession" role="tabpanel">
  <p>Is this section still necessary?</p>
</div>
</div>
</div>
