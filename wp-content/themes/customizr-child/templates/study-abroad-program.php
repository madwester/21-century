<?php
/*
Template Name: Study Abroad Program Template
*/
...
<div class="tab-pane active" id="step1" role="tabpanel">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <h3>Please choose your highest education or current grade</h3>
        <div class="dropdown">
...
<button type="button" class="btn btn-secondary" data-toggle="step2">Next step</button>
      </div>
    </div>
  </div>
</div>
